...
namespace CodeReason.Reports
{
    ...
    public class ReportData
    {
        ...
        private List<InlineSection> _inlineSections = new List<InlineSection>();
        /// <summary>
        /// Gets a list of data tables
        /// </summary>
        public List<InlineSection> InlineSections
        {
            get { return _inlineSections; }
        }

        private List<StyleTable> _styleTables = new List<StyleTable>();
        /// <summary>
        /// Gets a list of data tables
        /// </summary>
        public List<StyleTable> StyleTables
        {
            get { return _styleTables; }
        }
