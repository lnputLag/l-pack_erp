...
namespace CodeReason.Reports.Barcode
{
    public class Ean13
    {
        ...
        */
        private float _fMinimumAllowableScale = .1f;
        private float _fMaximumAllowableScale = 100.0f;
        ...
        {
            float width = this.Width * this.Scale * this.Scale2X;
            float height = this.Height * this.Scale * this.Scale2Y;
        ...
        public System.Drawing.Bitmap CreateBitmap( float w=0,float h=0 )
        {
            ...
            g.FillRectangle( new System.Drawing.SolidBrush( bgColor ), new Rectangle( 0, 0, (int)tempWidth, (int)tempHeight ) );
        ...
        public float Scale2X { get;set;}
        public float Scale2Y { get;set;}
