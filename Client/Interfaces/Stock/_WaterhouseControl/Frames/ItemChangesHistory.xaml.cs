...
namespace Client.Interfaces.Stock
{
    ...
    public partial class ItemChangesHistory : UserControl
    {

        public ItemChangesHistory(int id, string currentCell = null, string itemName = null)
        {
            InitializeComponent();
       ...
       /// </summary>
        private async void StorageGridLoadItems()
        {
            ...
            q.Request.SetParam("Action", "HistoryChanges");
        ...
        public void Show()
        {
            ...
            Central.WM.Show(frameName, "История изменений", true, "add", this);
