...
{
    /// <summary>
    /// Форма списка водителей погрузчиков Каширы
    /// </summary>
    /// <author>sviridov_ae</author>
    public partial class ForkliftDriverKshList : UserControl
    {
        public ForkliftDriverKshList()
        {
            InitializeComponent();
        ...
        public string RoleName = "[erp]forklift_drivers_ksh";

        private string FrameName = "ForkliftDriverKshList";
        ...
        public void Destroy()
        {
            ...
            {
                ReceiverGroup = "ForkliftDriversKsh",
                ReceiverName = "",
