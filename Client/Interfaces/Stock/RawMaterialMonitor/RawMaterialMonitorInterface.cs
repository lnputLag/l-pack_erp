...
namespace Client.Interfaces.Stock.RawMaterialMonitor
{
    ...
    public class RawMaterialMonitorInterface
    {
        public RawMaterialMonitorInterface()
        {
            ...
            var monitorCompositionCards = Central.WM.CheckAddTab<RawCompositionMaterialMonitorCardsTab>("MonitorCardsControl_Composition", "Карточки", false, "MonitorControl_Composition", "bottom");
