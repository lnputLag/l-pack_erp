...
{
    /// <summary>
    /// Интерфейс для создания и редактирования Мест
    /// </summary>
    /// <author>eletskikh_ya</author>
    public partial class WarehouseCell : ControlBase
    {
        public WarehouseCell()
        {
            ControlTitle = "Редактирование места";
        ...
        /// (primary key записи таблицы wms_cell)
        /// </summary>
        ...
        public void SetDefaults()
        {
            ...
            if (CellId > 0)
            {
                CellNumTextBox.IsReadOnly = true;
                GetData();
            }
            else
            {
                CellNumTextBox.Focus();
            }
        }
        ...
        public void Show()
        {
            ...
            this.FrameName = $"{FrameName}_{CellId}";
            if (CellId == 0)
            {
                Central.WM.Show(FrameName, "Новое место", true, "add", this);
            }
            else
            {
                Central.WM.Show(FrameName, $"Место {CellId}", true, "add", this);
            }
        }
        ...
        public async void GetData()
        {
            ...
            {
                p.CheckAdd("WMCE_ID", CellId.ToString());
            }
