...
namespace Client.Interfaces.Accounts
{
    ...
    public partial class AccountTab4 : ControlBase
    {
        /*
        ...
        public void ProcessCommand(string command, ItemMessage m=null)
        {
            ...
            if(!command.IsNullOrEmpty())
            {
                switch(command)
                {
                    ...
                    {
                            AccountGrid.SelectAllRows(true);
                        }
                        break;

                    case "account_select_none":
                        {
                    ...
                    case "account_selected_list":
                        {
                            ...
                            var d = new LogWindow($"{s}", "Выбранные строки");
                            d.ShowDialog();
                            ...
                            {
                                {
                                    ...
                                    new DataGridContextMenuItem()
                                    {
                                        ...
                                        Action=()=>
                                        {
                                            ProcessCommand("account_select_all");
                                        },
                                    }
                                },
                                {
                                    ...
                                    new DataGridContextMenuItem()
                                    {
                                        ...
                                        Action=()=>
                                        {
                                            ProcessCommand("account_select_none");
                                        },
                                    }
                                },
                            }
        ...
        private void SelectAll_Click(object sender, RoutedEventArgs e)
        {
            ...
            if(checkBox != null)
            {
                var v = (bool)checkBox.IsChecked;
                AccountGrid.SelectAllRows(v);
            }
        }
    }
}
