...
namespace Client.Interfaces.Sales
{
    ...
    public partial class SalesUnshippedReport : UserControl
    {
        public SalesUnshippedReport()
        {
            InitializeComponent();
        ...
        public string RoleName = "[erp]sales_report_unshipped";
        ...
        /// <summary>
        /// интервал работы контроля длительности
        /// </summary>
        ...
        public async void LoadItems()
        {
            ...
            if (resume)
            {
                ...
                q.Request.SetParam("Action", "MakeProductsNotShipped");
                q.Request.Timeout=180000;
        ...
        /// <summary>
        /// Запуск таймера обновления прогресс-бара
        /// </summary>
            ...
            if(ProgressUpdateInterval!=0)
            {
                if(ProgressUpdateTimer == null)
                {
...

                    {
                        ...
                        Central.Stat.TimerAdd("SalesUnshippedReport_RunProgressTimer", row);
                    }
            ...
            if(ControlUpdateInterval!=0)
            {
                if(ControlUpdateTimer == null)
                {
...

                    {
                        ...
                        row.CheckAdd("DESCRIPTION", "");
                        Central.Stat.TimerAdd("SalesUnshippedReport_RunControlTimer", row);
                    }
        ...
        /// <summary>
        /// Обработчик изменения выбора партнера
        /// </summary>
        /// <param name="d"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// Обработчик изменения выбора офиса продаж
        /// </summary>
        /// <param name="d"></param>
        /// <param name="e"></param>
