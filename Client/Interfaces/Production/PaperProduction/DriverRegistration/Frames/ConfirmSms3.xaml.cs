...
namespace Client.Interfaces.Production
{
    ...
    /// <changed>2025-10-06</changed>
    /// <version>2</version>
    public partial class ConfirmSms3 : WizardFrame
    {
        public ConfirmSms3()
        {
            InitializeComponent();
        ...
        private void SetPhoneNumber()
        {
            ...
            // если отправили вторую смс водителю
            if (CountSendSms  == 2)
            {
                c = SentCode;
        ...
        /// </summary>
        private void GetData3(List<Dictionary<string, string>> list)
        {
            SmsVisibleIs = 0;
