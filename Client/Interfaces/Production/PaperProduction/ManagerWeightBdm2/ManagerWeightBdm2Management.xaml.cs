        ...
        {
            {
                ...
                GridLog.UseSorting = false;
                GridLog.UseRowHeader = false;
        ...
        {
            {
                ...
                var columns = new List<DataGridHelperColumn>
                {
                    ...
                    new DataGridHelperColumn
                    {
                        Header="Масса c Полигона",
                        Path="WEIGHT_LANDFILL",
                        Doc="Масса Полигон",
                        ColumnType=ColumnTypeRef.Integer,
                        MinWidth=160,
                        MaxWidth=160,
                ...
                GridCarbage.PrimaryKey = "CHGA_ID";
                GridCarbage.Label = "Carbage";
                GridCarbage.UseSorting = false;
                GridCarbage.AutoUpdateInterval = 30;
                GridCarbage.UseRowHeader = true;
                GridCarbage.SelectItemMode = 0;
