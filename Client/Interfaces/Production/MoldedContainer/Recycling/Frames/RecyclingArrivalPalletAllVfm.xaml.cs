...
{
    /// <summary>
    /// Форма со списком оприходованных паллет с заготовками на ЛТ для ВФМ
    /// </summary>
    /// <author>greshnyh_ni</author>
    public partial class RecyclingArrivalPalletAllVfm : ControlBase
    {
        public RecyclingArrivalPalletAllVfm()
        {
            InitializeComponent();
        ...
        private async void LoadItems()
        {
            ...
            q.Request.SetParam("Action", "PalletAllListVfm");
