...
{
    /// <summary>
    /// Форма со списком оприходованных паллет с заготовками для ЛТ
    /// </summary>
    /// <author>greshnyh_ni</author>
    public partial class RecyclingConsumptionPalletAll : ControlBase
    {
        public RecyclingConsumptionPalletAll()
        {
            InitializeComponent();
        ...
        {
            IdSt = "";
            ObjectName = "ConsumptionPalletAll";
            TabName = $"{ObjectName}";
        }

        public void Edit()
        {
            ControlName = $"ConsumptionPalletAll_{IdSt}";
            Grid.LoadItems();
            Show();
        }
        ...
        public void Show()
        {
            string title = $"Список оприходованных паллет с заготовками";
            TabName = $"{ObjectName}";
