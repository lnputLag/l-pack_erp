...
namespace Client.Interfaces.Production.Testing
{
    ...
    public partial class ProductionTaskForTestingKsh : ControlBase
    {
        public ProductionTaskForTestingKsh()
        {
            InitializeComponent();
        ...
        private async void LoadRef()
        {
            ...
            q.Request.SetParam("Module", "ProductionPr");//Можно использовать общий модуль
