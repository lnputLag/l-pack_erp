...
{
    /// <summary>
    /// Интерфейс технолога с заданиями для изготовления образцов
    /// </summary>
    /// <author>ryasnoy_pv</author>
    public partial class SampleTaskList : ControlBase
    {
        public SampleTaskList()
        {
            InitializeComponent();
