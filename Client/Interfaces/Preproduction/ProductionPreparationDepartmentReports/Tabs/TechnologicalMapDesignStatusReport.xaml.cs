...
{
    /// <summary>
    /// Отчет по статусам техкарт у дизайнеров
    /// </summary>
    public partial class TechnologicalMapDesignStatusReport : ControlBase
    {
        public TechnologicalMapDesignStatusReport()
        {
            InitializeComponent();
            ControlTitle = "Отчёт по статусам ТК с печатью";
            ...
            //инициализация грида
            {
                ...
                var columns = new List<DataGridHelperColumn>
                {
                    ...
                    new DataGridHelperColumn
                    {
                        Header="Поступило",
                        Group="Статус",
                        Description="Поступило техкарт с печатью дизайнерам",
                        Path="CREATED_CNT",
                    ...
                    new DataGridHelperColumn
                    {
                        Header="Принято",
                        Group="Статус",
                        Description="Принято в работу техкарт с печатью дизайнерами",
                        Path="ACCEPTANCE_CNT",
                        ColumnType=ColumnTypeRef.Double,
                        Format="N0",
                        Width2=17,
                    ...
                    new DataGridHelperColumn
                    {
                        Header="Не принято",
                        Group="Статус",
                        Description="Не принято в работу техкарт с печатью дизайнерами",
                        Path="TODO_CNT",
                        ColumnType=ColumnTypeRef.Double,
                        Format="N0",
                        Width2=17,
                    ...
                    new DataGridHelperColumn
                    {
                        Header="Выполнено",
                        Group="Статус",
                        Description="Выполнено техкарт с печатью дизайнерами",
                        Path="DONE_CNT",
                        ColumnType=ColumnTypeRef.Double,
                        Format="N0",
                        Width2=17,
        ...
        public async void ReportGridLoadItems()
        {
            ...
            q.Request.SetParam("Action", "ListForDesignStatusReport");
