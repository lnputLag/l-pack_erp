...
{
    /// <summary>
    /// Список штанцформ Каширы
    /// </summary>
    public partial class CuttingStampKshTab : ControlBase
    {
        public CuttingStampKshTab()
        {
            InitializeComponent();

            ControlTitle = "Штанцформы КШ";
            ...
            Commander.SetCurrentGridName("StampItemGrid");
            {
                ...
                Commander.Add(new CommandItem()
                {
                    ...
                    CheckEnabled = () =>
                    {
                        ...
                        if (row != null)
                        {
                            result = CuttingStampTab.CheckEnabledForSetStatus(row.CheckGet("STATUS_ID").ToInt(), 9);
                        }
                        return result;
                    }
                });
                */
                ...
                Commander.Add(new CommandItem()
                {
                    ...
                    CheckEnabled = () =>
                    {
                        ...
                        if (row != null)
                        {
                            result = CuttingStampTab.CheckEnabledForSetStatus(row.CheckGet("STATUS_ID").ToInt(), 11);
                        }
                        return result;
                    }
                });
                */
                Commander.Add(new CommandItem()
                {
                    ...
                    CheckEnabled = () =>
                    {
                        ...
                        if (row != null)
                        {
                            result = CuttingStampTab.CheckEnabledForSetStatus(row.CheckGet("STATUS_ID").ToInt(), 18);
                        }
                        return result;
                    }
                });
        ...
        /// <summary>
        /// Фильтрация строк в таблице изделий
        /// </summary>
        ...
        private async void SetStatus(int newStatus)
        {
            ...
            if (row != null)
            {
                bool result = CuttingStampTab.SetStampItemStatus(newStatus, row.CheckGet("ID").ToInt(), row.CheckGet("STATUS_ID").ToInt(), row.CheckGet("CELL_ID"), "", this.FactoryId);
                if (result)
                {
                    StampGrid.LoadItems();
                }
        ...
        private void MoveStampItem()
        {
            ...
            if (row != null)
            {
                bool result = CuttingStampTab.MoveStampItem(row.CheckGet("ID").ToInt(), row.CheckGet("CELL_ID"), "");
                if (result)
                {
                    StampGrid.LoadItems();
                }
        ...
        public async void MakeTransportLabel(int transportId)
        {
            var q = new LPackClientQuery();
            q.Request.SetParam("Module", "Rig");
