...
namespace Client.Interfaces.Preproduction
{
    ...
    public partial class TechnologicalMapTabEngineers : ControlBase
    {
        public TechnologicalMapTabEngineers()
        {
            InitializeComponent();
            ...
            TabName = "TechnologicalMapTabEngineers";
            OnLoad = () =>
            {
                LoadRef();
                LoadStatuses();
                    ...
                    if (msg.ReceiverName == ControlName)
                    {
                        switch (msg.Action)
                        {
                            case "Refresh":
                                ...
                                break;
                            case "Rework":
                                var m = JsonConvert.DeserializeObject<Dictionary<string, string>>(msg.Message);
                                if (m.CheckGet("REASON") == "4")
                                {
                                    TechMapChangeDesignStatus(1, m.CheckGet("ID").ToInt());
                                }
                                Grid.LoadItems();
                                break;
                        }
                ...
                Commander.SetCurrentGridName("Grid");
                {
                    Commander.SetCurrentGroup("standart");
                    {
                        ...
                        Commander.Add(new CommandItem()
                        {
                            ...
                            Description = "Создание новой техкарты",
                            AccessLevel = Role.AccessMode.FullAccess,
                            Action = () =>
                            {
                                var techCardFrame = new MoldedContainerTechCard();
                        ...
                        Commander.Add(new CommandItem()
                        {
                            ...
                            Title = "Копия",
                            MenuUse = true,
                            MenuTitle = "Создать копию",
                            ButtonUse = true,
                            ButtonName = "CreateCopyButton",
                            Description = "Создать копию техкарты",
                            AccessLevel = Role.AccessMode.FullAccess,
                            Action = () =>
                            {
                                var k = Grid.GetPrimaryKey();
                                var id = Grid.SelectedItem.CheckGet(k).ToInt();
                                if (id != 0 && Grid.SelectedItem.CheckGet("STATUS_ID").ToInt() != 1)
                                {
                                    var techCardFrame = new MoldedContainerTechCard();
                                    techCardFrame.ReceiverName = ControlName;
                                    techCardFrame.Edit(id, true);
                                }
                            },
                            CheckEnabled = () =>
                            {
                        ...
                        Commander.Add(new CommandItem()
                        {
                            ...
                            MenuUse = true,
                            MenuTitle = "Привязать техкарту",
                            ButtonUse = false,
                            ButtonName = "",
                            Description = "Привязать готовую техкарту",
                            AccessLevel = Role.AccessMode.FullAccess,
                            Action = () =>
                            {
                                var attachTk = new MoldedContainerAttachTechCard();
                                attachTk.Show();
                                int attachId = attachTk.AttachId;

                                var k = Grid.GetPrimaryKey();
                                var mainId = Grid.SelectedItem.CheckGet(k).ToInt();
                                if (attachId != 0 && mainId != 0)
                                {
                                    var techCardFrame = new MoldedContainerTechCard();
                                    techCardFrame.ReceiverName = ControlName;
                                    techCardFrame.Edit(mainId, true, attachId);
                                }
                            },
                            CheckEnabled = () =>
                            {
                                ...
                                var k = Grid.GetPrimaryKey();
                                var row = Grid.SelectedItem;
                                if (row.CheckGet(k).ToInt() != 0 && row.CheckGet("STATUS_ID").ToInt() == 3)
                                {
                                    result = true;
                                }
                                return result;
                        ...
                        Commander.Add(new CommandItem()
                        {
                            ...
                            Description = "Внесение изменений в техкрту",
                            AccessLevel = Role.AccessMode.FullAccess,
                            Action = () =>
                            {
                                var k = Grid.GetPrimaryKey();
                            ...
                            CheckEnabled = () =>
                            {
                                ...
                                var k = Grid.GetPrimaryKey();
                                var row = Grid.SelectedItem;
                                var status = row.CheckGet("STATUS_ID").ToInt();
                                if (row.CheckGet(k).ToInt() != 0 && status!=1)
                                {
                                    result = true;
                                }
                                return result;
                        ...
                        Commander.Add(new CommandItem()
                        {
                            ...
                            Description = "Удаление разрабатываемой техкарты",
                            AccessLevel = Role.AccessMode.FullAccess,
                            Action = () =>
                            {
                                var k = Grid.GetPrimaryKey();
                            ...
                            CheckEnabled = () => 
                            {
                                ...
                                if (row.CheckGet(k).ToInt() != 0 && status != 1)
                                {
                                    if (row.CheckGet("PRODUCT_ID").ToInt() == 0 && status != 1)
                                    {
                                        result = true;
                                    }
                                }
                    ...
                    Commander.SetCurrentGroup("special");
                    {
                        Commander.Add(new CommandItem()
                        {
                            ...
                            Action = () =>
                            {
                                var rework = new MoldedContainerRework();
                                rework.TkId = Grid.SelectedItem.CheckGet("ID").ToInt();
                            ...
                            CheckEnabled = () =>
                            {
                                ...
                                var row = Grid.SelectedItem;
                                if (row.CheckGet("STATUS_ID").ToInt().ContainsIn(3,4))
                                {
                                    result = true;
                                }
                                return result;
                        ...
                        Commander.Add(new CommandItem()
                        {
                            ...
                            Action = () =>
                            {
                                TechMapChangeDesignStatus(1, Grid.SelectedItem.CheckGet("ID").ToInt());
                            },
                            CheckEnabled = () =>
                            {
                                var result = false;
                                var status = Grid.SelectedItem.CheckGet("STATUS_ID").ToInt();
                                var design = Grid.SelectedItem.CheckGet("DESIGN"); 
                                int typeId = Grid.SelectedItem.CheckGet("CONTAINER_TYPE_ID").ToInt();
                                if ((typeId == 2 || typeId == 3 || typeId == 4) && status.ContainsIn(3,4,5,6))
                                {
                                    if (design.ToInt() == 0)
                                    {
                                        result = true;
                        ...
                        Commander.Add(new CommandItem()
                        {
                            ...
                            Action = () =>
                            {
                                TechMapChangeDesignStatus(0, Grid.SelectedItem.CheckGet("ID").ToInt());
                            },
                            CheckEnabled = () =>
                            {
                                var result = false;
                        ...
                        Commander.Add(new CommandItem()
                        {
                            ...
                            Description = "Принять техкарту в работу",
                            AccessLevel = Role.AccessMode.FullAccess,
                            Action = () =>
                            {
                                var dw = new DialogWindow("Вы действительно хотите принять техкарту в работу?", "Принять техкарту", "", DialogWindowButtons.NoYes);
                                if ((bool)dw.ShowDialog())
                                {
                                    TechMapChangeStatus(3,1);
                                }
                            },
                            CheckEnabled = () =>
                            {
                        ...
                        Commander.Add(new CommandItem()
                        {
                            ...
                            Description = "Отклонить техкарту",
                            AccessLevel = Role.AccessMode.FullAccess,
                            Action = () =>
                            {
                                var dw = new DialogWindow("Вы действительно хотите отклонить техкарту?", "Отклонить техкарту", "", DialogWindowButtons.NoYes);
                                if ((bool)dw.ShowDialog())
                                {
                                    TechMapChangeStatus(2,1);
                                }
                            },
                            CheckEnabled = () =>
                            {
                        ...
                        Commander.Add(new CommandItem()
                        {
                            ...
                            Description = "Отправить на согласование клиенту",
                            ButtonUse = true,
                            ...
                            {
                                var result = false;
                                if (Grid.SelectedItem.CheckGet("STATUS_ID").ToInt() == 3)
                                {
                                    result = true;
                                }
                                return result;
                        ...
                        Commander.Add(new CommandItem()
                        {
                            Name = "return_from_confirm",
                            Enabled = true,
                            Group = "operations",
                            Title = "Вернуть от клиента",
                            Description = "Вернуть от клиента",
                            ButtonUse = false,
                            ButtonName = "",
                            MenuUse = true,
                            Action = () =>
                            {
                                var dw = new DialogWindow("Вы действительно вернуть техкарту от клиента?", "Вернуть техкарту", "", DialogWindowButtons.NoYes);
                                if ((bool)dw.ShowDialog())
                                {
                                    TechMapChangeStatus(3,0);
                                }
                            },
                            CheckEnabled = () =>
                            {
                                var result = false;
                                if (Grid.SelectedItem.CheckGet("STATUS_ID").ToInt() == 4)
                                {
                                    result = true;
                                }
                                return result;
                        ...
                        Commander.Add(new CommandItem()
                        {
                            ...
                            {
                                var result = false;
                                var statusId = Grid.SelectedItem.CheckGet("STATUS_ID").ToInt();
                                if(statusId.ContainsIn(3,4))
                                {
                                    // Привязываем дизайн к контейнеру с печатью
                                    int typeId = Grid.SelectedItem.CheckGet("CONTAINER_TYPE_ID").ToInt();
        ...
        /// </summary>
        private async void TechMapChangeStatus(int status, int confirmed_dttm_flag)
        {
            ...
            q.Request.SetParam("CONFIRMED_DTTM_FLAG", confirmed_dttm_flag.ToString());
        ...
        /// </summary>
        private async void TechMapChangeDesignStatus(int status, int id)
        {
            var q = new LPackClientQuery();
            q.Request.SetParam("Module", "Preproduction");
            q.Request.SetParam("Object", "MoldedContainer");
