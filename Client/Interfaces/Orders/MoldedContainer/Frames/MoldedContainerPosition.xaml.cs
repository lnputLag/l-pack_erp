...
{
    /// <summary>
    /// Логика взаимодействия для MoldedContainerPosition.xaml
    /// </summary>
    public partial class MoldedContainerPosition : ControlBase
    {
        public MoldedContainerPosition()
        {
            InitializeComponent();
            InitForm();
            SetDefaults();
        ...
        private async void GetData()
        {
            ...
            q.Request.SetParam("Action", "GetPosition");
        ...
        public void Edit(int id = 0)
        {
            ...
            if (hasPz)
            {
                ProductSelectButton.Visibility = Visibility.Collapsed;
            }
        ...
        private async void SaveData(Dictionary<string, string> p)
        {
            ...
            q.Request.SetParam("Module", "Orders");
            q.Request.SetParam("Object", "MoldedContainer");
            q.Request.SetParam("Action", "SavePosition");
